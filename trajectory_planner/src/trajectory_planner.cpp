...
int main(int argc, char** argv)
{
  ...
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("/bbox_pose",1000, chatterCallback);
  ...
  static const std::string PLANNING_GROUP = "manipulator"; //manipulator move_group
    ...
    ROS_INFO("I heard:[ %f %f %f]",obj_pose.pose.orientation.x, obj_pose.pose.orientation.y, obj_pose.pose.orientation.z);
...
// Planning to a Pose goal
  ...
  geometry_msgs::PoseStamped tool_pose;
    ...
    double Delta=0.01;
        ...
        Mr.setValue(0,1,0,0,0,-1,-1,0,0);
        Me.setEulerYPR(0,-0.1258,-0.2538);
